			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="#pablo">Lista de votantes</a>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<a href="/ufps-elecciones/votantes/agregar">
									<p>Registrar nuevo votante</p>
								</a>
								<div class="table-responsive">
									<c:if test="${empty listaVotante}">
											...
											<tbody>
												<c:forEach var="votante" items="${listaVotante}">
													<tr>
														...
														<td><a
															href="/ufps-elecciones/votantes/editar?id=<c:out value='${votante.id}'/>"><i
																class="fas fa-edit fa-lg mr-2"></i></a> <a
															href="/ufps-elecciones/votantes/eliminar?id=<c:out value='${votante.id}'/>"><i
