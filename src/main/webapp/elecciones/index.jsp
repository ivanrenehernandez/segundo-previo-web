			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						...
						<a class="navbar-brand" href="#pablo">Lista de elecciones</a>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<a href="/ufps-elecciones/elecciones/agregar">
									<p>Registrar nueva elección</p>
								</a>
								<div class="table-responsive">
									<c:if test="${empty listaEleccion}">
											...
											<tbody>
												<c:forEach var="eleccion" items="${listaEleccion}">
													<tr>
														...
														<td><a href="/ufps-elecciones/elecciones/editar?id=<c:out value='${eleccion.id}'/>"><i
																class="fas fa-edit fa-lg mr-2"></i></a> <a
															href="/ufps-elecciones/elecciones/eliminar?id=<c:out value='${eleccion.id}'/>"><i
